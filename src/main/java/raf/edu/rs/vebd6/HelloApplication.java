...
import raf.edu.rs.vebd6.repository.comment.CommentRepPostgresSql;
import raf.edu.rs.vebd6.repository.comment.CommentRepository;
import raf.edu.rs.vebd6.repository.post.PostRepPostgresSql;
    ...
    public HelloApplication() {
        ...
        AbstractBinder binder = new AbstractBinder() {
            ...
            protected void configure() {
                this.bind(PostRepPostgresSql.class).to(PostRepository.class).in(Singleton.class);
                this.bind(CommentRepPostgresSql.class).to(CommentRepository.class).in(Singleton.class);
